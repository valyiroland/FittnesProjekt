...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Már 22. 20:09
...
(8, 'Grilled Cod with Spinach', 'Light and flavorful, this grilled cod is paired with a nutrient-rich spinach pasta mix, perfect for a healthy meal.'),
(9, ' Chili-Lime Baked Salmon with Sweet Potato Purée ', 'A spicy and zesty salmon fillet, oven-baked to perfection, served with a creamy sweet potato purée.\r\n'),
(10, 'Tuna Salad with Avocado', 'A refreshing salad with seared tuna, creamy avocado creating a perfect balance of flavors.'),
(11, 'Steamed Trout with Vegetable Rice', 'A delicate and aromatic dish where trout is gently steamed and served with a light rice mixed with fresh vegetables.'),
(12, 'Grilled Chicken Breast with Fresh Green Salad', 'A simple yet satisfying meal with juicy grilled chicken served over a bed of fresh greens.\r\n'),
(13, 'Honey-Mustard Chicken with Sweet Potato Wedges ', 'Oven-baked chicken glazed with honey mustard, served with crispy roasted sweet potato wedges.'),
(14, 'Avocado Salmon Steak with Grilled Vegetables', 'Rich in healthy fats, this grilled salmon is topped with creamy avocado and served with charred vegetables.'),
(15, 'Coconut Curry Salmon with Brown Rice ', 'A fragrant and mildly spicy dish featuring tender salmon simmered in coconut curry, served with brown rice.'),
(16, 'Lean Beef Steak with Steamed Broccoli and Sweet Potato', 'A classic healthy meal with a lean beef steak, nutritious broccoli, and roasted sweet potato.'),
(17, 'Shrimp and Coconut Basmati Rice', 'A creamy and mildly sweet dish with coconut-infused basmati rice and sautéed shrimp, perfect for a tropical twist.'),
(18, 'Brown Rice and Black Bean Bowl ', 'A high-fiber, protein-packed meal with brown rice, black beans, tomatoes, avocado, and a hint of lime.');
