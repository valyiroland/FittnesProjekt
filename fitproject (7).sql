...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Ápr 09. 19:37
...
--
-- A tábla adatainak kiíratása `fitproject_bmi`
--

INSERT INTO `fitproject_bmi` (`id`, `user_id`, `height`, `weight`, `bmi_value`, `date`) VALUES
(4, 10, 185, 85.00, 24.84, '2025-03-11');
...
--
-- A tábla adatainak kiíratása `fitproject_calories`
--

INSERT INTO `fitproject_calories` (`id`, `user_id`, `date`, `calorie_count`) VALUES
(10, 10, '2025-03-11', 2611),
(11, 10, '2025-03-11', 3111);
...
(6, 'Cauliflower', 25.00, 1, 'Cruciferous vegetable, rich in fiber and vitamins.', 'https://media.istockphoto.com/id/186828790/photo/cauliflower-isolated-on-white-background.jpg?s=612x612&w=0&k=20&c=oLL9OeCwhHolL-MqXb3CZEkL0NyE483_vEqm3Tj0Lzo='),
(7, 'Onion', 40.00, 1, 'Aromatic vegetable, commonly used for flavoring dishes.', 'https://media.istockphoto.com/id/513920379/photo/onion-bulbs.jpg?s=612x612&w=0&k=20&c=EqL8velNKYOIZmWhwZtt_WdWykIcaGBbPPJ4KA_PGOg='),
...
(9, 'Sweet Potato', 86.00, 1, 'Sweet and starchy root vegetable, rich in fiber.', 'https://t3.ftcdn.net/jpg/02/95/67/48/360_F_295674852_DGl8KenKjNp15lI7WVEHIRhD5PVqYaGb.jpg'),
...
(11, 'Lemon', 29.00, 2, 'Citrus fruit, rich in vitamin C and antioxidants.', 'https://media.istockphoto.com/id/1389128157/photo/lemon-fruit-with-leaf-isolated-whole-lemon-and-a-half-with-leaves-on-white-background-lemons.jpg?s=612x612&w=0&k=20&c=Gjyv0Yd0gMG4JZ5iE9e864ilZrurflx1gU6cKHn4E2s='),
...
(18, 'Carrot', 41.00, 1, 'A crunchy and sweet vegetable rich in beta-carotene and fiber.', 'https://www.healthbenefitstimes.com/9/gallery/carrot/Carrots.jpg'),
(19, 'Broccoli', 55.00, 1, 'A nutrient-dense vegetable high in vitamins C and K.', 'https://thumbs.dreamstime.com/b/broccoli-isolated-white-background-close-up-view-green-raw-vegetable-131618524.jpg'),
...
(25, 'Eggplant', 25.00, 1, 'A soft and spongy vegetable often used in Mediterranean and Asian dishes.', 'https://img.freepik.com/premium-photo/purple-eggplant-is-shown-white-background_867452-8783.jpg'),
...
(30, 'Brussels Sprouts', 43.00, 1, 'A cruciferous vegetable high in vitamin C and fiber.', 'https://www.shutterstock.com/image-photo/brussel-sprouts-isolated-on-white-600nw-1504812110.jpg'),
(31, 'Apple', 52.00, 2, 'A sweet, crisp fruit commonly eaten raw.', 'https://img.freepik.com/premium-photo/red-apples-isolated-white-background_299651-65.jpg'),
...
(34, 'Strawberry', 32.00, 2, 'A small, red fruit with a sweet flavor.', 'https://img.freepik.com/premium-photo/strawberry-white-background_183352-2854.jpg?w=360'),
(35, 'Pineapple', 50.00, 2, 'A tropical fruit with a tangy sweetness.', 'https://img.freepik.com/premium-photo/pineapple-isolated-white-background_253984-5776.jpg'),
...
(38, 'Watermelon', 30.00, 2, 'A large, watery fruit perfect for hot summer days.', 'https://img.freepik.com/premium-photo/watermelon-fruit-with-cut-piece-isolated-white-background_285124-2.jpg'),
...
(40, 'Mango', 60.00, 2, 'A tropical fruit known for its sweet, juicy flesh.', 'https://img.freepik.com/premium-photo/mango-isolated-ripe-red-mango-white-background-fresh-fruits_531456-661.jpg'),
...
(123, 'Rice', 130.00, 7, 'White rice is a refined grain with its husk, bran, and germ removed, making it soft, mild, and easy to digest. It is a great source of carbohydrates and is often enriched with vitamins. White rice is widely used in various dishes, from stir-fries to risottos, and pairs well with many flavors.', 'https://heavenuts.hu/wp-content/uploads/2020/04/F%C3%A9lk%C3%A9sz-el%C5%91f%C5%91z%C5%91tt-rizs.jpg'),
(124, 'Basmati Rice', 121.00, 7, 'Basmati rice is a long-grain rice known for its fragrant aroma and light, fluffy texture. It is commonly used in Indian and Middle Eastern cuisine and pairs well with curries and grilled dishes. Due to its lower glycemic index compared to regular white rice, it provides a more gradual release of energy.', 'https://listonic.com/phimageproxy/listonic/products/basmati_rice.webp'),
(125, 'Brown Rice ', 111.00, 7, 'Brown rice is a whole grain that retains its bran and germ, making it higher in fiber, vitamins, and minerals than white rice. It has a slightly nutty flavor and a chewy texture. Because it digests more slowly, it helps with prolonged energy release and better blood sugar control.', 'https://www.roopmahalrice.com/wp-content/uploads/2023/06/Everything-About-Brown-Rice-by-Roop-mahal-Rice-Brown-Rice-Nutrition-value-and-More.jpg'),
(126, 'Potato', 77.00, 1, 'Starchy root vegetable commonly used in soups and stews. Becomes soft and flavorful when cooked.', 'https://th.bing.com/th/id/OIP._MQi0JQh_oudcaVbdp3kzgHaHa?rs=1&pid=ImgDetMain'),
(127, 'Parsnip', 75.00, 1, 'Sweet and earthy white root vegetable, similar in texture to carrot. Adds depth to soups.', 'https://th.bing.com/th/id/OIP.N2QFWcHEUSdZhKQLJlWdqAHaE8?rs=1&pid=ImgDetMain');

-- --------------------------------------------------------

--
-- Tábla szerkezet ehhez a táblához `fitproject_passwordresets`
--

CREATE TABLE `fitproject_passwordresets` (
  `id` int(11) NOT NULL,
...
--
-- A tábla adatainak kiíratása `fitproject_passwordresets`
--

INSERT INTO `fitproject_passwordresets` (`id`, `email`, `token`, `expiry_time`) VALUES
(6, 'iroczkib@kkszki.hu', 'rv5KtEPvHl4TjK0v82B8KjivueEHzgxqqkX6S12CM', '2025-02-18 18:20:55'),
(7, 'radacsid@kkszki.hu', 'Y2X8hKz8DxmhBaBT1hQdasW79X5aaahNZFscdkecBfM', '2025-04-03 10:31:12');
...
(1, 'Grilled Chicken Salad', 'Grill a seasoned chicken breast until fully cooked. Slice it into strips and place it on a bed of fresh spinach and mixed greens. Add cherry tomatoes, cucumber slices, and red onion. Drizzle with a light vinaigrette dressing before serving.'),
(2, 'Sweet Potato and Black Bean Bowl', 'Roast diced sweet potatoes in the oven at 200°C (400°F) for about 25 minutes. In a bowl, combine black beans, cooked quinoa, and the roasted sweet potatoes. Season with lime juice, cumin, and a pinch of salt. Top with fresh avocado and cilantro.'),
(3, 'Salmon with Roasted Vegetables', 'Season a salmon fillet with salt, pepper, and olive oil. Roast bell peppers, zucchini, and cherry tomatoes at 200°C (400°F) for 20 minutes. Place the salmon on top and bake for another 12–15 minutes until cooked through. Serve warm.'),
(4, 'Chickpea and Spinach Stir-Fry', 'Sauté chopped onion and garlic in a pan with olive oil. Add chickpeas and stir-fry for 3–4 minutes. Toss in fresh spinach and cook until wilted. Season with salt, pepper, and a dash of lemon juice. Serve hot.'),
(5, 'Spaghetti with Tomato and Garlic Sauce', 'Cook spaghetti according to package instructions. In a pan, sauté minced garlic in olive oil, then add diced tomatoes and simmer for 10 minutes. Season with salt, pepper, and basil. Mix the sauce with the drained pasta and serve.'),
(6, 'Avocado and Tuna Salad', 'In a bowl, combine canned tuna, diced avocado, cucumber, and red onion. Add a squeeze of lemon juice and mix well. Serve chilled as a light salad.'),
(7, 'Quinoa and Roasted Vegetable Bowl', 'Cook quinoa according to package instructions. Roast bell peppers, zucchini, and cherry tomatoes in the oven at 200°C (400°F) for 20 minutes. Mix everything in a bowl and season with olive oil, salt, and pepper.'),
(8, 'Grilled Cod with Spinach', 'Season cod fillets with salt, pepper, and lemon juice. Grill for about 3–4 minutes per side until flaky. Sauté fresh spinach with garlic and olive oil. Serve the cod over the spinach.'),
(9, ' Chili-Lime Baked Salmon with Sweet Potato Purée ', 'Marinate a salmon fillet with lime juice, chili flakes, and olive oil for 30 minutes. Bake at 200°C (400°F) for 12–15 minutes. Meanwhile, boil and mash sweet potatoes with a little butter and salt. Serve together.'),
(10, 'Tuna Salad with Avocado', 'Mix canned tuna with diced avocado, Greek yogurt, and a pinch of salt. Serve on whole-grain toast or enjoy as a salad.'),
(11, 'Steamed Trout with Vegetable Rice', 'Steam trout fillets for about 10 minutes until fully cooked. Serve with rice cooked with peas, carrots, and a pinch of turmeric.'),
(12, 'Grilled Chicken Breast with Fresh Green Salad', 'Grill a chicken breast until fully cooked. Serve with a fresh salad made of lettuce, cucumber, cherry tomatoes, and a light vinaigrette dressing.\r\n'),
(13, 'Honey-Mustard Chicken with Sweet Potato Wedges ', 'Coat chicken breasts with a mix of honey, mustard, and olive oil. Bake at 200°C (400°F) for 20–25 minutes. Cut sweet potatoes into wedges, season with salt and paprika, and bake alongside the chicken.'),
(14, 'Avocado Salmon Steak with Grilled Vegetables', 'Grill a salmon steak for 4–5 minutes per side. Serve with grilled zucchini, bell peppers, and a fresh avocado salsa made with diced avocado, lime juice, and cilantro.'),
(15, 'Coconut Curry Salmon with Brown Rice ', 'Sauté onion, garlic, and ginger in a pan. Add coconut milk, curry powder, and salmon fillets. Simmer for 10 minutes. Serve over brown rice.'),
(16, 'Lean Beef Steak with Steamed Broccoli and Sweet Potato', 'Grill a lean beef steak to your desired doneness. Steam broccoli until tender and serve with roasted sweet potatoes.'),
(17, 'Shrimp and Coconut Basmati Rice', 'Cook basmati rice with coconut milk instead of water. Sauté shrimp with garlic, chili flakes, and lime juice. Serve the shrimp over the coconut rice.'),
(18, 'Brown Rice and Black Bean Bowl ', 'Cook brown rice according to package instructions. Mix with black beans, diced bell peppers, and a squeeze of lime juice. Serve warm.'),
(19, 'Traditional Hungarian Meat Soup (Húsleves)', 'A traditional Hungarian chicken soup made by gently simmering chicken pieces with chopped onion, carrot, parsnip, and potato. Once the broth is cleared of foam, the vegetables are added alongside a pinch of salt and black pepper. The soup is slowly cooked over low heat to develop a rich and comforting flavor. Just before serving, vermicelli noodles are added and cooked until tender. This golden broth, filled with tender chicken and hearty root vegetables, is perfect for a cozy meal.');
...
(4, 'iroczkib', '1e44f424c394ed94f49d41347952c3de1f550b990cfd98f72422848895160b51', 'male', 'f69365bdc867098226b7c563e3e53b86', 1, 0, 'iroczkib@kkszki.hu', '2025-02-14 08:10:04'),
(10, 'valyiroland', 'f840eb89663fe16c346de938b30c200cd926e798a1a9cdcb533972175af7347c', 'male', 'b97ffc2efd6644763dd97974e800b9f6', 1, 0, 'valyir@kkszki.hu', '2025-03-11 11:06:33'),
(11, 'radacsid', '08fe3b62e127ef02698ccc02812a0246dbaff788f93023c5b911ab845d3dd3d6', 'male', '02114ea6ffcdbcc738f322e0841ad991', 1, 0, 'radacsid@kkszki.hu', '2025-03-17 11:10:00'),
(12, 'tomcsa', '882701ca6ab97d091e083597e970e74c2c9cc49e27dcab03c89800087d05162b', 'female', '52e2c8d8f58bd70f7f4f0d5e823d5c41', 0, 0, 'fegyvernekit@kkszki.hu', '2025-04-07 11:30:59');
...
--
-- A tábla indexei `fitproject_passwordresets`
--
ALTER TABLE `fitproject_passwordresets`
  ADD PRIMARY KEY (`id`),
  ADD KEY `email` (`email`);
...
--
-- AUTO_INCREMENT a táblához `fitproject_passwordresets`
--
ALTER TABLE `fitproject_passwordresets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- Megkötések a táblához `fitproject_passwordresets`
--
ALTER TABLE `fitproject_passwordresets`
  ADD CONSTRAINT `fitproject_passwordresets_ibfk_1` FOREIGN KEY (`email`) REFERENCES `fitproject_users` (`email`) ON DELETE CASCADE;
